...
<div class="row">
    <div class="col-md-12">
        ...
        <form id="add_form" class="form-horizontal" enctype="multipart/form-data" role="form" method="POST"
              action="{{ route('script.update',$script->slug) }}">
            {{ csrf_field() }}
            {{ method_field('PUT') }}
            ...
            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6">
                    <input id="name" type="text" class="form-control" name="name"
                           value="{{ old('name',$script->name) }}" required autofocus>
            ...
            <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                <label for="description" class="col-md-4 control-label">Description
                    <br> <a href='https://guides.github.com/features/mastering-markdown/#syntax' target='_blank'>(MarkDown
                        compatible)</a>
                </label>

                <div class="col-md-6">
                    <textarea id="description" class="form-control"
                              name="description">{{ old('description',$script->description) }}</textarea>
            ...
            <div class="form-group{{ $errors->has('js_url') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6">
                    <input id="js_url" type="text" placeholder="http://.../usercript.js" class="form-control"
                           name="js_url" value="{{ old('js_url',$script->js_url) }}" required autofocus>
            ...
            <div class="form-group{{ $errors->has('last_update') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6">
                    <input id="last_update" type="text" placeholder="ex : 25/10/2016" class="form-control"
                           name="last_update"
                           value="{{ old('last_update',$script->last_update != null ? $script->last_update->format('d/m/Y') : null) }}">
            ...
            <div class="form-group{{ $errors->has('version') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6">
                    <input id="version" type="text" placeholder="" class="form-control" name="version"
                           value="{{ old('version',$script->version) }}">
            ...
            <div class="form-group{{ $errors->has('repo_url') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6">
                    <input id="repo_url" type="text" placeholder="http://github.com/..." class="form-control"
                           name="repo_url" value="{{ old('repo_url',$script->repo_url) }}">
            ...
            <div class="form-group{{ $errors->has('topic_url') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6">
                    <input id="topic_url" type="text" maxlength="255" placeholder="http://www.jeuxvideo.com/forums/..."
                           class="form-control" name="topic_url" value="{{ old('topic_url',$script->topic_url) }}">
            ...
            <div class="form-group{{ $errors->has('website_url') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6">
                    <input id="website_url" type="text" maxlength="255" placeholder="http://..." class="form-control"
                           name="website_url" value="{{ old('website_url',$script->website_url) }}">
            ...
            @if($script->photo_url != null)
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <img class="img-thumbnail img-responsive" style="max-width: 260px; max-height: 260px;"
                             src="{{($script->photo_url)}}" alt="{{$script->name}} logo"/>
                    </div>
                </div>
            @endif
            ...
            <div class="form-group{{ $errors->has('photo_url') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6">
                    <input id="photo_url" type="text" placeholder="http://image.noelshack.com/..." class="form-control"
                           name="photo_url" value="{{ old('photo_url') }}">
            ...
            <div class="form-group{{ $errors->has('photo_file') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6">
                    <input id="photo_file" type="file"  placeholder="Votre image" class="form-control" name="photo_file"
                    accept="image/*"  value="{{ old('photo_file') }}">
            ...
            <div class="form-group{{ $errors->has('don_url') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6">
                    <input id="don_url" type="text" placeholder="http://www.paypal.me/your_name/" class="form-control"
                           name="don_url" value="{{ old('don_url',$script->don_url) }}">
            ...
            @if ((Auth::check() && Auth::user()->isAdmin()))
                ...
                <div class="form-group{{ $errors->has('user_id') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-6">
                        ...
                        ?>
                        <input id="user_name" type="text" class="form-control typeahead" placeholder="Aucun owner"
                               autocomplete="off" name="user_name" value="{{ old('user_name', $user_name ) }}">
                        <input id="user_id" type="hidden" class="form-control" autocomplete="off" name="user_id"
                ...
                <div class="form-group{{ $errors->has('autor') ? ' has-error' : '' }}">
                    <label for="autor" class="col-md-4 control-label">Auteur du script (libellé)
                        <span class="fa-stack fa-1x " data-toggle="tooltip" title=""
                              data-original-title="Si l'auteur n'a pas de compte">
                    ...
                    <div class="col-md-6">
                        @if($user_id != '' and $user_name != '')
                            <input id="autor" type="text" class="form-control disabled" readonly="true" name="autor"
                                   value="{{ old('autor',$script->autor) }}">
                        @else
                ...
                <div class="form-group">
                    <label for="autor" class="col-md-4 control-label">Epinglé
                    </label>

                    <div class="col-md-1">
                        <input id="pinned" type="checkbox" class="form-control" name="pinned"
                               {{ old('pinned',$script->pinned) == "1" ? 'checked' : '' }} >
                    </div>
                </div>
            ...
            <div class="form-group{{ $errors->has('poster_user') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6">
                    <input id="poster_user" type="text" readonly="true" disabled="true" class="form-control disabled"
                           name="poster_user" value="{{ $script->poster_user()->first()->name }}">
                </div>
            </div>
